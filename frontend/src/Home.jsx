    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            As your Virtual Assistant, I’ll handle your admin, content writing,
            web development, social media, and any tasks that slow you down so
            you can focus on strategy, decision-making, and scaling your
            business.
          </Text>
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap={10} bg="brand.50">
          ...
          >
            ...
            <Text textStyle="body">
              ...
              challenges, and priorities. I'll listen, ask questions, and help you
              clarify what support you need.
            </Text>
          </Box>
